...
public class ImageViewUtil {
     ...
     * with scale_bigout_and_small_in type set to ImageView# ScaleType #CENTER_INSIDE.
     *
     ...
     * position of a Bitmap if it were placed inside a View with scale_bigout_and_small_in type set

...
public interface ICropperView {
     ...
     *
     * @return The current minimum scale_bigout_and_small_in level. What this value represents depends on the current
     ...
     * release
     * <p>&nbsp;</p>
     * Sets the minimum scale_bigout_and_small_in level. What this value represents depends on the current {@link
     * ImageView.ScaleType}.
     *
     * @param minScale minimum allowed scale_bigout_and_small_in
     */
    @Deprecated
     ...
     * ImageView.ScaleType}.
     *
     * @param minimumScale minimum allowed scale_bigout_and_small_in
     */
     ...
     *
     * @return The current middle scale_bigout_and_small_in level. What this value represents depends on the current
     * {@link ImageView.ScaleType}.
     */
    @Deprecated
    float getMidScale();
     ...
     * release
     * <p>&nbsp;</p>
     * Sets the middle scale_bigout_and_small_in level. What this value represents depends on the current {@link
     * ImageView.ScaleType}.
     *
     * @param midScale medium scale_bigout_and_small_in preset
     */
    @Deprecated
    void setMidScale(float midScale);

    /**
     * @return The current medium scale_bigout_and_small_in level. What this value represents depends on the current
     * {@link ImageView.ScaleType}.
     */
    float getMediumScale();

    /*
     * Sets the medium scale_bigout_and_small_in level. What this value represents depends on the current {@link android.widget.ImageView.ScaleType}.
     *
     * @param mediumScale medium scale_bigout_and_small_in preset
     */
     ...
     *
     * @return The current maximum scale_bigout_and_small_in level. What this value represents depends on the current
     * {@link ImageView.ScaleType}.
     */
    @Deprecated
    float getMaxScale();
     ...
     * release
     * <p>&nbsp;</p>
     * Sets the maximum scale_bigout_and_small_in level. What this value represents depends on the current {@link
     * ImageView.ScaleType}.
     *
     * @param maxScale maximum allowed scale_bigout_and_small_in preset
     */
    @Deprecated
     ...
     * ImageView.ScaleType}.
     *
     * @param maximumScale maximum allowed scale_bigout_and_small_in preset
     */
    void setMaximumScale(float maximumScale);

    /**
     * Returns the current scale_bigout_and_small_in value
     *
     * @return float - current scale_bigout_and_small_in value
     */
    float getScale();

    /**
     * Changes the current scale_bigout_and_small_in to the specified value.
     *
     * @param scale - Value to scale_bigout_and_small_in to
     */
    void setScale(float scale);

    /**
     * Return the current scale_bigout_and_small_in type in use by the ImageView.
     *
     ...
     *
     * @param scale   - Value to scale_bigout_and_small_in to
     * @param animate - Whether to animate the scale_bigout_and_small_in
     */
    void setScale(float scale, boolean animate);

    /**
     * Changes the current scale_bigout_and_small_in to the specified value, around the given focal point.
     *
     * @param scale   - Value to scale_bigout_and_small_in to
